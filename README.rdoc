...
To create a model
 rails g model Person name:string address:text dob:date aadharNum:string gender:string
...
To create a migration
 rails g migration LimitAadharNumberLength

To create model association. Look at schema.rb to see the change effected after the command is run
 rails g model birth_certificate name:string person:references
